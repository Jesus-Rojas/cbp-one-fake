...
function LoginPage () {
  ...
  return (
    <div className='login-page'>
      <img className='backdrop-image' src="/assets/images/backdrop.png" alt="" />
      <div className="container-dialog">
        <img className='cbp-seal-image' src="/assets/images/cbp_seal.png" alt="" />
        ...
        <img className='login-gov-image' src="/assets/images/login_gov.png" alt="" />
